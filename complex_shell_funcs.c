...
/**
* path_match- Return processed string matching @entry
...
/**
* s_sh_cd- Changes current directory to first element of @args
...
/**
* s_sh_setenv- Sets or updates an entry in the environment
* @args: [1] is the name of the environment variable
*        [2] is the new value for @args[1]
*        [3] None-zero overwrite, zero to not overwrite
* Return: 1 (if success)
*/
...
/**
* s_sh_unsetenv- Deletes an entry in the environment
